...
Restaurant::Restaurant() {
    ...
    case 1: {
        ...
        ((Node*)this)->set("employment", totalemployees1(gen) * (1 + ((diningSize - 12.5) / 12.5))) ; // number of employees influenced by size of restaurent
        ((Node*)this)->set("CO2Emission", 825 * ((1 + ((diningSize - 13 / 13))) / 10)) ; //on average 301 tons of CO2 per year, hence 825kg per day. 
...
void Restaurant::_register_methods()
{
    ...
    register_method((char*)"_on_Area_mouse_exited", &Structure::_on_Area_mouse_exited);
    */
    register_method((char*)"simulate_step", &Restaurant::simulate_step);
}
